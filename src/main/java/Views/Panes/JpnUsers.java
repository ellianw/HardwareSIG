 ...
 * @author Ellian
 */
public class JpnUsers extends AbstractPanel implements PaneInterface {
    ...
    private void initComponents() {
        ...
        searchVar.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID", "Nome", "Login" }));
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        UserEditor editor = new UserEditor(getFrame(), true);
    ...
    public String getSearchExpression(){
        ...
        if (value.isBlank()) return clause;
        
        clause = switch (column) { // Switch is a expression that return a value;
            case "id" -> "id = "+value;
            case "nome" -> "lower(name) like '%"+value+"%'";
            case "login" -> "lower(login) like '%"+value+"%'";
            default -> null;
        };
